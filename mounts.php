...
function mountform($mount){
	...
	$output.="<tr><td>MindestDK:</td><td><input name='mount[mindk]' value=\"".htmlentities($mount['mindk'])."\" size='40'></td></tr>";
	$output.="<tr><td>Faktor für Kosten bei Tiertrainer:</td><td><input name='mount[trainingcost]' value=\"".htmlentities($mount['trainingcost'])."\" size='40'></td></tr>";
