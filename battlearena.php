...
if ($_GET['op'] == "")
{
    ...
    if ($session['user']['gold'] > 0 && $session['user']['gold'] < 50)
    {
        output("Leider bemerkst du, dass du nicht genug Gold hast.`n");
    }
    if ($session['user']['gold'] > 49 && $session['user']['turns'] > 0 && $session['user']['hitpoints'] >= $int_min_hp)
    {
...
if ($_GET['op'] == "pay")
{
    ...
    {
        addnav("`2Quintus","battlearena.php?op=Quintus");
    }
    ...
    {
        addnav("`2Lucius","battlearena.php?op=Lucius");
    }
    ...
    {
        addnav("`2Proximo","battlearena.php?op=Proximo");
    }
    ...
    {
        addnav("`@Ultimus","battlearena.php?op=Ultimus");
    }
    if ($session['user']['battlepoints'] >= 736 and $session['user']['dragonkills'] > 13)
    {
        addnav("`@Extremus","battlearena.php?op=Extremus");
    }
}
if ($_GET['op'] == "win")
{
...
if ($battle)
{
    ...
    */
    if ($victory)
    {
        ...
        if ($badguy['creaturename']=="`@Cicero`0")
        {
            addnav("Weiter","battlearena.php?op=win&op2=Cicero");
        }
        if ($badguy['creaturename']=="`@Vibius`0")
        {
            addnav("Weiter","battlearena.php?op=win&op2=Vibius");
        }
        if ($badguy['creaturename']=="`@Quintus`0")
        {
            addnav("Weiter","battlearena.php?op=win&op2=Quintus");
        }
        if ($badguy['creaturename']=="`@Cassius`0")
        {
            addnav("Weiter","battlearena.php?op=win&op2=Cassius");
        }
        if ($badguy['creaturename']=="`@Lucius`0")
        {
            addnav("Weiter","battlearena.php?op=win&op2=Lucius");
        }
        if ($badguy['creaturename']=="`@Aurelius`0")
        {
            addnav("Weiter","battlearena.php?op=win&op2=Aurelius");
        }
        if ($badguy['creaturename']=="`@Proximo`0")
        {
            addnav("Weiter","battlearena.php?op=win&op2=Proximo");
        }
        if ($badguy['creaturename']=="`@Maximus`0")
        {
            addnav("Weiter","battlearena.php?op=win&op2=Maximus");
        }
        if ($badguy['creaturename']=="`@Ultimus`0")
        {
            addnav("Weiter","battlearena.php?op=win&op2=Ultimus");
        }
        if ($badguy['creaturename']=="`@Extremus`0")
        {
            addnav("Weiter","battlearena.php?op=win&op2=Extremus");
        }
    ...
    else if ($defeat)
    {
        ...
        if ($badguy['creaturename']=="`@Ultimus`0")
        {
            addnav("Weiter","battlearena.php?op=loose&op2=Ultimus");
        }
        if ($badguy['creaturename']=="`@Extremus`0")
        {
            addnav("Weiter","battlearena.php?op=loose&op2=Extremus");
        }
        output("`n`n`3Deine Gesundheit: `n");
