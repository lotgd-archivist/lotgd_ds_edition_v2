...
$sql="SELECT acctid,name,goldinbank FROM accounts WHERE name like '".addslashes($newplayer)."' LIMIT 1";
$result = db_query($sql) or die(db_error(LINK));
$rownew = db_fetch_assoc($result);

$sql="SELECT acctid,name,goldinbank FROM accounts WHERE name like '".addslashes($newdk)."' LIMIT 1";
$result = db_query($sql) or die(db_error(LINK));
