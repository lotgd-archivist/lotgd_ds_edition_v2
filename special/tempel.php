...
if ($HTTP_GET_VARS[op]=="verlassen"){    
	...
	if ($HTTP_GET_VARS[betrag]>$session[user][gold])	{
		...
		output("`nAm Geräusch, das deine Goldstücke beim Einwerfen verursachen, vermutest du, dass bisher etwa ".max( ($drin+round($drin/100*e_rand(-3,3))) , $betrag)." gespendet worden sein muss. ");
