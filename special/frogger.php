...
if ($_GET['op']=="kiss")
{
    ...
    case 4:
        ...
        break;
    case 5:
        output("`2".($session[user][sex]?"Der Frosch ":"Die Kröte ")."verwandelt sich tatsächlich, und vor dir steht ".($session[user][sex]?"ein strahlender Prinz":"eine bildhübsche Prinzessin").".`n".($session[user][sex]?"Er ":"Sie ")."bedankt sich überschwängloch bei dir und verkündet deine heldenhafte Tat im ganzen Reich, was dir `^maximales Ansehen`2 einbringt!`0`n");
